...
export const swapComposition = (config, resizeCanvasTo) => {
    ...
    if (dstImage && srcImage) {
        ...
        return Object.assign(Object.assign({}, config), { [dstImage]: config[srcImage], [srcImage]: config[dstImage], [dst + 'Transform']: config[src + 'Transform'], [src + 'Transform']: config[dst + 'Transform'], resizeCanvasTo, swapImages: true });
    }
    return config;
};
