...
export const createImageFilter = (name, shape) => ((_a) => {
    ...
    checkStyle(style);
    return (<IFKImageFilter style={[defaultStyle, style]} config={JSON.stringify(finalizeConfig(config, images))} onIFKFilteringError={onFilteringError || id} onIFKFilteringStart={onFilteringStart || id} onIFKFilteringFinish={onFilteringFinish || id} onIFKExtractImage={onExtractImage || id} {...pick(props, restPropKeys)}>
