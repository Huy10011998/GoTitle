...
export class migration_1603914754470 implements MigrationInterface {
    ...
    async up(queryRunner: QueryRunner): Promise<any> {
        ...
        console.warn("Remove currentOwnerDeedId in title");
        console.warn("Remove UNIQUE on location in title");
    }
